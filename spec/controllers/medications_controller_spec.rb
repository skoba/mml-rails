...
RSpec.describe MedicationsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all medications as @medications" do
      ...
      expect(assigns(:medications)).to eq([medication])
    end
  end
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved medication as @medication" do
        post :create, {:medication => invalid_attributes}, valid_session
        expect(assigns(:medication)).to be_a_new(Medication)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested medication" do
        medication = Medication.create! valid_attributes
        put :update, {:id => medication.to_param, :medication => new_attributes}, valid_session
        medication.reload
      ...
      it "redirects to the medication" do
        medication = Medication.create! valid_attributes
        put :update, {:id => medication.to_param, :medication => valid_attributes}, valid_session
        expect(response).to redirect_to(medication)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the medication as @medication" do
        medication = Medication.create! valid_attributes
        put :update, {:id => medication.to_param, :medication => invalid_attributes}, valid_session
        expect(assigns(:medication)).to eq(medication)
      end
