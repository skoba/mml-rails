class MedicationsController < ApplicationController
  ...
  private
    ...
    def medication_params
      params.require(:medication).permit(:prescription_id, :name, :code, :dose, :dose_unit, :frequency, :duration, :instruction, :prn, :route, :form, :batchNo, :brand_alternative, :long_term)
    end
end
